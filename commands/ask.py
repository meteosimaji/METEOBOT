...
class Ask(commands.Cog):
    ...
    async def _ask_impl(
        ...
        instructions = (
            ...
            "When tool sequencing is unclear, search recipe titles/goals in docs/skills/ask-recipes/SKILL.md using shell (e.g., `rg -n -m 50 \"^## \" docs/skills/ask-recipes/SKILL.md` or `rg -n -m 50 \"^Goal:\" docs/skills/ask-recipes/SKILL.md`) and only read the matching section. "
